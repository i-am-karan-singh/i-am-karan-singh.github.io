...
\Description{Provably efficient algorithms and fundamental limits for \textit{feedback-driven} learning, spanning both \textit{prediction} and \textit{control}. Drawing from the algorithmic toolkits of \textit{optimization} and \textit{online learning}, together with techniques from \textit{dynamical systems} and \textit{control theory}, recent results have lead to the first instance-optimal control algorithm, and provably efficient learning in dynamical systems that exhibit long-term correlations.} 
